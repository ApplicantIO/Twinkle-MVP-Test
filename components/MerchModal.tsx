...
export default function MerchModal({ item, isOpen, onClose }: MerchModalProps) {
  ...
  const fullDescription = item.description || `This is an official Twinkle brand product. Made from high-quality materials and designed for long-lasting use. Delivery available throughout Uzbekistan.`;

  // Word count check for description toggle
    ...
    >
      ...
      >
        ...
        <div className="w-full md:w-1/2 bg-zinc-800 relative flex-shrink-0 flex flex-col">
          ...
          {/* Dot Indicators (pagination) - Only show if multiple images */}
          {hasMultipleImages && (
