...
function getSampleVideoById(id: string): any | null {
  const sampleVideos = [
    ...
    // Konsta Tarix Playlist Videos
    {
      id: 'video-vatan',
      userId: 'konsta-creator',
      title: 'Konsta - Vatan',
      description: 'Vatan albomidan',
      thumbnailUrl: 'https://img.youtube.com/vi/jfKfPfyJRdk/maxresdefault.jpg',
      videoUrl: 'https://www.youtube.com/embed/jfKfPfyJRdk',
      views: 125000,
      category: 'Music',
    ...
    },
    {
      id: 'video-alhimik',
      userId: 'konsta-creator',
      title: 'Konsta - Alhimik',
      description: 'Alhimik albomidan',
      thumbnailUrl: 'https://img.youtube.com/vi/jfKfPfyJRdk/maxresdefault.jpg',
      videoUrl: 'https://www.youtube.com/embed/jfKfPfyJRdk',
      views: 189000,
      category: 'Music',
